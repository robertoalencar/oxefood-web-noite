        ...
        <>
            <Routes>
                ...
                <Route  path="/list-cliente" element={
                        <ProtectedRoute> <ListCliente /> </ProtectedRoute>
                    }
                />
                ...
                <Route path="list-produto" element={ 
                        <ProtectedRoute> <ListProduto/> </ProtectedRoute> 
                    } 
                />

                <Route path="form-entregador" element={ 
                        <ProtectedRoute> <FormEntregador/> </ProtectedRoute> 
                    } 
                />

                <Route path="form-cupomdesconto" element={ 
                        <ProtectedRoute> <FormCupomDesconto/> </ProtectedRoute>
                    } 
                />

                <Route path="list-cupomdesconto" element={ 
                        <ProtectedRoute> <ListCupomDesconto/> </ProtectedRoute>
                    } 
                />
